            ...
            <div class="card-content">
              <div class="card-body">
                <form method="POST" action="{{ route('register') }}">
                  ...
                  <div class="form-group mb-2">
                    <label class="text-bold-600" for="Referal_Code">Referal Code</label>
                    <input id="Referal_Code" type="text" class="form-control" name="referal_code"   placeholder="Referal Code">
                  </div>
