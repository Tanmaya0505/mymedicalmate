        ...
        <div class="row clearfix">
            <div class="col-12">
                <div class="text-center wow fadeInDown">
                    <h2 class="center mb30">Diseases Listings</h2>
                </div>
                    ...
                    <div class="card-body" id="filter-content">
                        <form method="GET" action="">
                            ...
                            <div class="form-group">
                                <label for="id1">Name of Disease</label>
                        ...
                        <table>
                            <tr class="hl-header">
                                <td style="width:40%;" class="text-left">
                                    <span class="verified">Diseases <i class="fas fa-check-circle"></i></span>
                                </td>
                                ...
                                <tr class="ast-bx-flex">
                                    ...
                                    <div class="item-image">
                                        <a href="{{ url('/diseases/detail/'.urlencode($val->full_name)) }}">
                                    ...
                                    <div class="item-detail">
                                            <ul>
                                                <li>Name of Disease: <Strong>{{ ucwords($val->full_name) }}</Strong></li>
                                                <li>Refer by Hospital/Doctor: <Strong>{{ $val->references_hos_doc }}</Strong></li>
                                                <li></li>
                                            </ul>
                                    </div>
                                </td>
                                ...
                                <td class="text-right">
                                    <a href="{{ url('/diseases/detail/'.urlencode($val->full_name)) }}" class="primary-btn">View Details</a>
                                </td>
                            </tr>
                        </table>
                    </div>
