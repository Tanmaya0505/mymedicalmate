    ...
    <div class="row">
            ...
            <div class="panel">
                <div class="user-heading round">
                    ...
                    <div class="user-details">
                        <b><!-- <i class="fal fa-user"></i> -->Name of Exam:</b> {{ ucwords($data->full_name) }}<br>
                        <b><!-- <i class="fal fa-map-marker-alt"></i> -->Last date of Apply:</b> 
                        {{ date('d-m-Y', strtotime($data->last_date_of_apply)) }}<br>
                        <b><!-- <i class="fal fa-map-marker-alt"></i> -->Total Vacancy:</b> 
                        {{ $data->total_vacancy }}<br>
                        <b><!-- <i class="fal fa-map-marker-alt"></i> -->Exam Date:</b> 
                        {{ date('d-m-Y', strtotime($data->exam_date)) }}<br>
                        <b><!-- <i class="fal fa-map-marker-alt"></i> -->Total Vacancy:</b> 
                        {{ $data->references_site }}<br>
        ...
        <div class="col-lg-7 col-xl-8">
            <div class="profile-info">
                <h4 class="mb20">Examination Post filed Details</h4>
