        ...
        <div class="row clearfix">
            <div class="col-12">
                <div class="text-center wow fadeInDown">
                    <h2 class="center mb30">Hospital Listings</h2>
                </div>
                    ...
                    <div class="card-body" id="filter-content">
                        <form method="GET" action="">
                            ...
                            <div class="form-group">
                                <label for="id1">Hospital Name</label>
                        ...
                        <table>
                            <tr class="hl-header">
                                <td style="width:40%;" class="text-left">
                                    <span class="verified">Hospital <i class="fas fa-check-circle"></i></span>
                                </td>
                                ...
                                <tr class="ast-bx-flex">
                                    ...
                                    <div class="item-image">
                                        <a href="{{ url('/hospital/detail/'.urlencode($val->full_name)) }}">
                                            <img src="{{ $photo }}" class="img-fluid" alt="">
                                        </a>
                                        <span>Established Year: {{ @$val->etablished_year }} </span>
                                    </div>
                                </td>
                                    <td class="ast-dtl">
                                    <div class="item-detail">
                                            <ul>
                                                <li>Hospital Name: <Strong>{{ ucwords($val->full_name) }}</Strong></li>
                                                <li>Location: <Strong>{{ $val->location }}</Strong></li>
                                                <li>Type of Hospital: <Strong>{{ $val->type_hospital  }}</Strong></li>
                                                <li>Multi Specialist: <Strong>{{ $val->multi_specialist=='0'?'No':'Yes' }}</Strong></li>
                                ...
                                <td class="text-right">
                                    <a href="{{ url('/hospital/detail/'.urlencode($val->full_name)) }}" class="primary-btn">View Details</a>
                                </td>
                            </tr>
                        </table>
                    </div>
