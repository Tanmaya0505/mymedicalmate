    ...
    <div class="row">
            ...
            <div class="panel">
                <div class="user-heading round">
                    <div class="d-flex bd-highlight align-items-center">
                        <div class="info-icon">
                            <p class="">YOE: {{$data->etablished_year}} </p>
                        </div>
                    ...
                    <div class="user-details">
                        <b><!-- <i class="fal fa-user"></i> -->Hospital Name:</b> {{ ucwords($data->full_name) }}<br>
                        <b><!-- <i class="fal fa-map-marker-alt"></i> -->Location:</b> {{ $data->location }}<br>
                        
                        <b><!-- <i class="fal fa-map-marker-alt"></i> -->Type of Hospital:</b> {{ $data->type_hospital }}<br>
                        <b><!-- <i class="fal fa-map-marker-alt"></i> -->Specialized in:</b> {{ $data->specialized }}<br>
                        <b><!-- <i class="fal fa-map-marker-alt"></i> -->Multi Specialist:</b> {{ $data->multi_specialist=='0'?'No':'Yes' }}<br>
                    </div>
                </div>
        ...
        <div class="col-lg-7 col-xl-8">
            <div class="profile-info">
                <h4 class="mb20">Hospitals Details</h4>
                <ul class="list-group detail-profile-list">
                    ...
                    <li class="list-group-item">
                        <i class="fal fa-eye"></i>
                        <span><strong>{{ $data->telephone}}</strong></span>
                    </li>
