        ...
        <div class="row clearfix">
            <div class="col-12">
                <div class="text-center wow fadeInDown">
                    <h2 class="center mb30">Pharmaceutical Institution  Listings</h2>
                </div>
                    ...
                    <div class="card-body" id="filter-content">
                        <form method="GET" action="">
                            ...
                            <div class="form-group">
                                <label for="id1">Name of Institution</label>
                        ...
                        <table>
                            <tr class="hl-header">
                                <td style="width:40%;" class="text-left">
                                    <span class="verified">Pharmaceutical Institution  <i class="fas fa-check-circle"></i></span>
                                </td>
                                ...
                                <tr class="ast-bx-flex">
                                    ...
                                    <div class="item-image">
                                        <a href="{{ url('/pharmas/detail/'.urlencode($val->full_name)) }}">
                                    ...
                                    <div class="item-detail">
                                            <ul>
                                                <li>Name of Institution: <Strong>{{ ucwords($val->full_name) }}</Strong></li>
                                ...
                                <td class="text-right">
                                    <a href="{{ url('/pharmas/detail/'.urlencode($val->full_name)) }}" class="primary-btn">View Details</a>
                                </td>
                            </tr>
                        </table>
                    </div>
