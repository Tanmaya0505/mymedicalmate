    ...
    <div class="row">
            ...
            <div class="panel">
                <div class="user-heading round">
                    ...
                    <div class="user-details">
                        <b><!-- <i class="fal fa-user"></i> -->Name of Institution:</b> {{ ucwords($data->full_name) }}<br>
                        <b><!-- <i class="fal fa-map-marker-alt"></i> -->Location:</b> {{ $data->location }}<br>
                        <b><!-- <i class="fal fa-map-marker-alt"></i> -->Course Offered:</b> {{ $data->course_offered }}<br>
                    </div>
                </div>
        ...
        <div class="col-lg-7 col-xl-8">
            <div class="profile-info">
                <h4 class="mb20">Pharmaceutical Institution  Details</h4>
