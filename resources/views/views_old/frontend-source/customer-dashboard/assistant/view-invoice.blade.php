    ...
    @endforelse
                                ...
                                <div class="invoice-table">
                                    ...
                                    <div class="row contact-inf mb50">
                                        ...
                                        <div class="col-md-4">
                                            <a class="btn btn-primary btn-fill" href="">Download</a>
                                        </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form novalidate id="payment-prescription-form" action="{{url('/assistant/payment-prescription')}}" method="post"  enctype="multipart/form-data">
                  @csrf
                    <input type="hidden" name="booking_id" id="booking_id" value="{{$prescription->order_id}}" />
                    <input type="hidden" name="vendor_id" id="vendor_id" value="{{$vendor->id}}" />
                    <input type="hidden" name="total_amount" id="total_amount" value="{{$total_final}}" />
                    ...
                    <ul class="list-group">
                        ...
                        Total Payable Rs {{$total_final}}
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center ">
                            <p>Total Available Coin (1451)</p>
                            <p>Apply coin 50</p>
                    ...
                    <div style='height: 0px;width: 0px; overflow:hidden;'><input id="upfile" type="file"  name="receipt" onchange="sub(this)" /></div>
                    ...
                    <div class="form-group mt-5">
                        ...
                        <button type="button" id="btn-sendmedicalmate" class="btn btn-primary btn-sm btn-fill float-right">SEND TO MEDICINE STORE </button>
