                ...
                <form method="POST" action="{{ url('assistant/upload-prescription') }}" enctype="multipart/form-data" id="upload-prescription" class="text-center">
                    ...
                    <div class="prescription-gray-form">
                        ...
                        <div class="input-group presc-row" id="medicine">
                            ...
                            <div class="rows col-12 marg-bot-10">

                                <div class="medicine-file d-inline-block wd-10">
                                    ...
                                    <input type="file" accept="image/png, image/jpg, image/jpeg, application/pdf, application/msword, application/vnd.ms-excel," name="photo_0" />

                                </div>
                                <div class="input-group-prepend d-inline-block wd-30">
                                    <input type="text" class="form-control d-inline-block" name="medicine[]" placeholder="Medicine Name">
                                </div>
                                ...
                                <div class="input-group-prepend d-inline-block wd-10">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="full_name" placeholder="Full Name" value="{{ old('full_name',$patient_details->patient_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="mobile_no" placeholder="Mobile No" value="{{ old('mobile_no',$patient_details->patient_mobile) }}">
...
<script>
    ...
    $(document).on('click', '#medicine .add-more', function(){
        ...
        if(count <= 9){
            ...
            let domEl = "<div class='rows col-12 marg-bot-10'><div class='medicine-file d-inline-block wd-10'><label for='file-input'><img src='/frontend-source/images/upl-btn.png'></label><input type='file' accept='image/png, image/jpg, image/jpeg, application/pdf, application/msword, application/vnd.ms-excel,' name='photo_"+count+"' /></div><div class='input-group-prepend d-inline-block wd-30'><input type='text' class='form-control d-inline-block' name='medicine[]' placeholder='Medicine Name'></div><div class='input-group-prepend d-inline-block wd-30'><input type='text' class='form-control' name='quantity[]' placeholder='Quantity'></div><div class='input-group-prepend d-inline-block wd-10'><input type='button' class='form-control red-btn add-more' value='+'></div></div>";

            $('#medicine-append').append(domEl);
