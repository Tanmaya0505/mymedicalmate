                        ...
                        <div
                            ...
                            <div class="txtTinyMce-wrapper"
                                ...
                                <p style="margin: 0; font-size: 16px; line-height: 1.5; word-break: break-word; text-align: center; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">
                                    <span style="font-size: 16px;">Dear Customer {{ $data['customer_det']['patient_name'] }},<br />
                                    Your booking has been cancelled By Admin<br /><br />
                                    <strong>Reason of Cancellation</strong> : {{ $data['cancel_reason'] }}</span>
                                </p>
                            </div>
                        </div>
