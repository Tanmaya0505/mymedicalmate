                        ...
                        <div
                            ...
                            <div class="txtTinyMce-wrapper"
                                ...
                                <p style="margin: 0; font-size: 16px; line-height: 1.5; word-break: break-word; text-align: center; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">
                                    <span style="font-size: 16px;">A new user has booked a service with Medical Mate {{ $adminData['assistant_name'] }}.</span>
                                </p>
                                ...
                                <p style="margin: 0; font-size: 16px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">Name: {{ $adminData['customer_meta']['patient_name'] }}</p>
                                <p style="margin: 0; font-size: 16px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">Email: {{ $adminData['customer_meta']['patient_email'] }}</p>
                                <p style="margin: 0; font-size: 16px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">Phone: {{ $adminData['customer_meta']['patient_mobile'] }}</p>
                                <p style="margin: 0; font-size: 16px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">Booking ID: {{ $adminData['booking_id'] }}</p>
                                <p style="margin: 0; font-size: 16px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">Book Date: {{ $adminData['book_date'] }}</p>
                                <p style="margin: 0; font-size: 16px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">Arrival Time: {{ $adminData['arrival_time'] }}</p>
                                <p style="margin: 0; font-size: 16px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">Pickup Status: @if($adminData['pickup_status']) Yes @else No @endif</p>
                            </div>
                        </div>
