            ...
            <div class="card-content">
                <div class="card-body">
                    <div class="col-12 col-sm-6 col-lg-3 d-flex align-items-right pull-right">
                        <a href="{{url('/cms-admin/add-question-answar')}}" class="btn btn-primary btn-block glow users-list-clear mb-0">Add QuestionAnswar</a>
                    </div>
                    <!-- datatable start -->
                        ...
                        <table id="users-list-datatable" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ url('/cms-admin/question-answar/edit/'.$coupon->id) }}"><i class="fas fa-edit"></i></a>
                                    <a href="{{ url('/cms-admin/question-answar/delete/'.$coupon->id) }}" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i></a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
