                                        ...
                                        <div class="patient-info row">
                                            <div class="col-md-6">
                                                <ul>
                                                    ...
                                                    <li class="shp-data"><i class="fas fa-shipping-fast"></i> Medicine Shipment By: <span>@if($data->ship_type == 2) Delivery Boy @else SELF @endif</span>
                                                        <ul class="shp-info">
                                                            @if($data->ship_type == 2)
                                            ...
                                            <div class="col-md-6">
                                                <i class="fas fa-location-arrow"></i> <strong>Delivery Address:</strong>
