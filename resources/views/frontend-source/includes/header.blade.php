    ...
    <div class="container">
        <div class="row">
            ...
            <div class="mb-vsbl-nv col-8 col-lg-3 d-flex align-content-center justify-content-end">
                <ul class="list-inline mb-0" style="margin-top: 20px;">
        ...
        <div class="row clearfix">
            <div class="col-12">
                <div class="input-group search">
                    ...
                    <div class="input-group-append" style="margin-left: 0px; border-radius: 5px;">
                        <button class="btn btn-secondary" type="button" style="margin-left: -55px; margin-top: 5px;">
