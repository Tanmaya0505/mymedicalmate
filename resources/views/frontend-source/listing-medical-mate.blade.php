...
<script>
    var url="{{url('/book-medical-mate/serial/')}}";
$( "#filter-btn" ).click(function() {
    $('#filter-content').slideToggle();
});
function OpenBooking(booking_id){
    $('#directBookingwithmedmate #serialbook').attr('href',"{{url('/book-medical-mate/serial/')}}"+'/'+booking_id);
    $('#directBookingwithmedmate #fullbook').attr('href',"{{url('/book-medical-mate/fullbook/')}}"+'/'+booking_id);
