...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 Prescription-view-details">
                ...
                <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#addMedicine">Add Medicine</button>
    ...
    @empty
    @endforelse
    <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#addMedicine">+</button>
                ...
                @if(count($allmedicines) > 0)
                  <a href="{{url('vendor/send-invoice/3/'.$prescription->order_id)}}" class="btn btn-info btn-sm" >Save & Send Invoice</a>
                @endif
            </div>
        </div>
    </div>
