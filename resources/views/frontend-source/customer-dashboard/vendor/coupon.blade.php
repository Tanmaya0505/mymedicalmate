                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        ...
                                                        <!-- @if(in_array($coupon->status,[0,1,2]))
                                                            @if($coupon->is_vendor_assigned  == 0)
                                                                <a title="Accept" @if($coupon->customer_status == 1) href='javascript:void(0)' onClick="AcceptService(2,{{$prescValue->vendor_id}},{{$value->order_id}})" @endif href="javascript:void(0);" class="btn btn-sm bg-secondary btn-fill @if($value->customer_status != 1) disabled @endif">
                                                            ...
                                                            @else
                                                                ...
                                                                <a title="Cancel" @if($coupon->customer_status == 2) href="{{ url($account_prefix.'/status-change/3/'.$prescValue->vendor_id.'/'.$value->order_id) }}" @endif href="javascript:void(0);" class="btn btn-sm bg-secondary btn-fill @if($value->customer_status != 2)disabled @endif">
