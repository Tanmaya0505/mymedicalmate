...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h4 class="mb-4">Coin Transfer History</h4>
                
                
                <div class="col-md-12">
                <a class="btn btn-primary btn-fill mb-2 float-right" onclick="addCoinTransfer()" href="javascript:void(0)">Convert Coin to Money</a>
                </div>
                <br/><br/>
                <div class="appointment-tab col-md-12">
                                        ...
                                        <table class="table table-hover table-center mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $value->transfer_coins }}</td>
                                                    <td>{{ $value->converted_price }} </td>
