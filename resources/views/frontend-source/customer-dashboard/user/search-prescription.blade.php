...
<div class="content">
    <div class="container-fluid">
            ...
            <form>
                <div class="row border rounded py-2 mb-2">
                    <div class="col-12 col-sm-6 col-lg-3">
                        <label for="users-list-verified">Delivery Location Pin Code</label>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <label for="users-list-status">Discount</label>
                        <fieldset class="form-group">
                            <input type="text" name="discount" placeholder="Discount" class="form-control" value="{{@$_GET['discount']}}">
                        </fieldset>
                    </div>
                    <div class="col-12 col-sm-6 col-lg-3">
                        <label for="users-list-role">Store Name</label>
                        <fieldset class="form-group">
                            <input type="text" name="store_name" placeholder="Store Name" class="form-control" value="{{@$_GET['store_name']}}">
                        </fieldset>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <h4 class="mb-4">Search by Pin or Location ({{$pin}})</h4>
                                        ...
                                        <div class="row">
                                             @foreach($vendors as $key=>$value)
                                                ...
                                                <div class="card col-5 ml-5" >
                                                    ...
                                                    <p>Working Hours: {{$meta->from_time}} -{{$meta->to_time}}</p>
