                                ...
                                <div class="invoice-table">
                                    <div class="row mt-3 border-tb">
                                        ...
                                        <div class="col-12 col-sm-7 col-md-5 text-grey text-90 order-first order-sm-last">
                                            ...
                                            $total_final_amount = ($total_amount-$total_discount+$tax_amount);
                                            @endphp
                                            <div class="row my-2">
                                                <div class="col-7 text-right">
                                    ...
                                    <div class="row contact-inf mb50">
                                        <div class="col-md-8">
                                            <p>Name:{{$prescription->full_name}}</p>
                                            <p>Call:{{$prescription->mobile_no}}</p>
                ...
                <form novalidate id="payment-prescription-form" action="{{url('/assistant/payment-prescription')}}" method="post">
                  @csrf
                    ...
                    <div class="form-group mt-5">
                        ...
                        <a href="{{ url($account_prefix.'/status-change/4/'.$VendorPrescriptionexist->vendor_id.'/'.$prescription->order_id) }}" id="btn-sendmedicalmate" disabled class="btn btn-primary btn-sm btn-fill float-right">SEND TO MEDICINE STORE </a>
