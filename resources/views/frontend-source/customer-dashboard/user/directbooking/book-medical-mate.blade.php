                ...
                <div class="booking-form">
                    ...
                    <form class="needs-validation" novalidate id="book-assistant-direct">
                        ...
                        <div class="form-group">
                            ...
                            <input placeholder="Patient Name" type="text" name="patient_name" id="patient_name" value="{{isset($userdata['first_name']) ? @$userdata['first_name'].' '.@$userdata['last_name'] :''}}" class="form-control" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="gender" id="patient_gender" required>
                        ...
                        <div class="form-group arrival_time d-none">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 mt-3 p-0 d-none" id="play_amount"><strong class="text-primary">Expected Pay Amount</strong> <span id="pay_amount"></span></div>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
    ...
    $('input[type=radio][name=early_serial_status]').change(function() {
      ...
      $('input[type=radio][name=booking]').change(function() {
        ...
        let amount = 0;
        if (this.value == 1) {
            amount = {{ isset($data['min_day_charge']) ? $data['min_day_charge'] : 0 }}+'-'+{{ isset($data['max_day_charge'])  ?  $data['max_day_charge'] : 0 }};
        } else if (this.value == 2) {
            amount = {{ isset($data['min_night_charge'])  ?  $data['min_night_charge'] : 0 }}+'-'+{{ isset($data['max_night_charge'])  ?  $data['max_night_charge'] : 0 }};
        } else if (this.value == 3){
            amount = ({{ $data['min_day_charge'] ? $data['min_day_charge']+$data['min_night_charge'] : 0 }} +'-'+ {{ isset($data['max_day_charge'])  ?  $data['max_day_charge']+$data['max_night_charge'] : 0 }});
        }else{
            amount =  {{ isset($data['min_hourly_charge'])  ?  3*$data['min_hourly_charge'] : 0 }}+'-'+{{ isset($data['max_hourly_charge'])  ?  3*$data['max_hourly_charge'] : 0 }};
        }
