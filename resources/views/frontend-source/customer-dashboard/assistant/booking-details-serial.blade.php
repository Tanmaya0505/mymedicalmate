            ...
            <div class="col-md-12">
                ...
                @php
                    ...
                    if(!empty($value->assistant_boy_id)){
                        ...
                        $customerId = $assistant->customerId;
                        ...
                        $age = 'Age ' . \Carbon\Carbon::now()->diffInYears(\Carbon\Carbon::parse($assistant_boy_meta['dob']));
                                    ...
                                    <div class="col-9">
                                        ...
                                        <div class="doc-info-cont">
                                            ...
                                            <p class="m-0"><strong>
                                                ...
                                                {{ $customerId }}</strong></p>
                                                <p class="m-0">Age: <strong>{{ $age }}({{ $assistant_boy_meta['gender'] }})</strong></p>
                                    ...
                                    <div class="col-12">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <i class="far fa-money-bill-alt"></i>{{ @$value->extend_hour  }} Hour
                                       ...
                                       <!--  <a title="Accept Request" href="javascript:void(0)" data-id="{{ $value->booking_id }}" onclick="acceptBooking('{{ $value->booking_id }}')"><span class="badge badge-pill bg-warning-light"> <i class="nc-icon nc-tap-01"></i> Accept</span></a> -->
                                        ...
                                        @if(!$value->activeBooking)
                                            @if(\Carbon\Carbon::now()->timestamp > $booking_date_time->timestamp)
                                ...
                                <div class="white-bx">
                                    ...
                                    <div class="widget about-widget">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item d-flex justify-content-between align-items-center border-0">
                                            Advance Paid Amount :
                                            <span class="">Rs.{{ $value->advance_price}}</span>
                                            </li>
                                            <li class="list-group-item d-flex justify-content-between align-items-center border-0">
                                            Total Payable Amount :
                                            <span class="">Rs.{{ $value->grand_price - $value->advance_price}}</span>
                                            </li>
                                            @if($value->paid==1)
                                            <li class="list-group-item d-flex justify-content-between align-items-center border-0">
                                        ...
                                        @endif
                                        @else
                                            <div class="alert alert-info">Waiting For Payment from User</div>
