    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <h4 class="mb-4">BOOKING DETAILS1</h4>

                @php

                $assistant_boy_meta = json_decode($assistant->meta, true);

                if(!empty($assistant_boy_meta)){
                ...
                $age = 'Age ' . $assistant_boy_meta['dob'];
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        ...
                                        <div class="doc-info-cont">
                                            ...
                                            <p class="m-0"><strong>
                                                ...
                                                {{ $assistant->customerId }}</strong></p>
                                                <p class="m-0">Age: <strong>{{ @$assistant_boy_meta['age'] }}({{ $assistant_boy_meta['gender'] }})</strong></p>
                                    ...
                                    <div class="col-12">
                                        ...
                                        @elseif($value->booking_status == 2 && $value->assistant_boy_id == Session::get('userId'))
                                        ...
                                        @if(!$value->activeBooking)
                                            ...
                                            @if($value->booking_type=='fullbook' && \Carbon\Carbon::now()->timestamp > $booking_date_time->timestamp)
                            ...
                            <div class="col-xl-7">
                                ...
                                <div class="white-bx">
                                    ...
                                    @if(isset($medmate) && $medmate->status == 0)
                                    <a title="Accept Request" class="btn btn-info btn-fill" href="javascript:void(0)" data-id="{{ $value->booking_id }}" onclick="acceptRequestBooking('{{ $value->booking_id }}')"><span class="badge badge-pill bg-warning-dark"> <i class="nc-icon nc-tap-01"></i> Accept</span></a>

                                    <a title="Accept Request" class="btn btn-danger btn-fill" href="javascript:void(0)" data-id="{{ $value->booking_id }}" onclick="declineRequestBooking('{{ $value->booking_id }}')"><span class="badge badge-pill bg-warning-dark"> <i class="nc-icon nc-tap-01"></i> Decline</span></a>
                                    @elseif(isset($medmate) && $medmate->status == 1)
                                         <a title="Accept Request" class="btn btn-danger btn-fill"  ><span class="badge badge-pill bg-warning-dark"> <i class="nc-icon nc-tap-01"></i> Accepted</span></a>
                                    @elseif(isset($medmate) && $medmate->status == 2)
                                         <a title="Accept Request" class="btn btn-danger btn-fill"  ><span class="badge badge-pill bg-warning-dark"> <i class="nc-icon nc-tap-01"></i> Declined</span></a>
                                    @endif
                                    ...
                                    @else
                                        ...
                                        <ul class="d-flex flex-wrap">
                                            ...
                                            <li class="list-group-item list-group-item-info">Service Time:<br/><p id="time_to_left"></p></li>
                                        </ul>
                                        @endif
                                    @endif
