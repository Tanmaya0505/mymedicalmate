                    ...
                    <div class="card-body booking-details-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-5">
                                ...
                                @if(Session::get('check_prescription_status')==1 && !$data->selectvendorprescription)
                                <div class="row">
                                        ...
                                        @if($value->payment_status==1)
                                            ...
                                            @if($meta->name_of_store)
                                                <div class="card col-12 " >
                                                    ...
                                                    <a href="{{ url($account_prefix.'/download-invoice/'.$data->order_id) }}" data-id="{{$value->id}}"  class="card-link btn btn-info btn-fill ">
                                ...
                                <div class="row">
                                    @foreach($data->vendorprescriptions as $key=>$value)
                                        ...
                                        <div class="card col-12 " >
                                            ...
                                            @if($value->min_amount)
                                            <a href="javascript:void(0)" data-id="{{$value->id}}" data-medicine='{{$value->medicine_list}}' class="card-link btn btn-primary btn-fill detailamt mt-2">
                                                    Details</a>
                                            @endif
                                            </div>
                                        </div>
