                                ...
                                <div class="invoice-table">
                                    <div class="row mt-3 border-tb">
                                        ...
                                        <div class="col-12 col-sm-7 col-md-5 text-grey text-90 order-first order-sm-last">
                                            ...
                                            <div class="row my-2">
                                                <div class="col-7 text-right">
                                                    Discount ({{$VendorPrescriptionexist->discount}}%)
                                                </div>
                                                <div class="col-5">
                                    ...
                                    @if(count($allmedicines) > 0 && $allmedicines[0]->created_by==2)
                                        <div class="row contact-inf mb50">
                                            <a href="{{url('vendor/send-invoice/3/'.$prescription->order_id)}}" class="btn btn-info btn-sm col-6" >Send to Patient & Vendor</a>
                ...
                <form novalidate id="add-medicine-form" action="{{url('/vendor/add-medicine')}}" method="post">
                  @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" onkeypress="return isNumber(event)" name="quantity" required="" id="quantity">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" onkeypress="return isNumber(event)" name="price" required="" id="price">
