                        ...
                        <div
                            ...
                            <div class="txtTinyMce-wrapper"
                                ...
                                <p
                                    ...
                                    <span style="font-size: 16px;">Dear Customer {{ $data['customer_det']['patient_name'] }},<br /><br />
                                    Your booking request id {{ $data['booking_id'] }} has been  confirmed . Your assistant boy will contact you soon.</span>
                                </p>
                                <p style="margin: 0; font-size: 16px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;"><b>Assistant Boy details:</b></p>
                                <p style="margin: 0; font-size: 16px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">Name: {{ $data['assistant_boy_det']['first_name'] . ' ' . $data['assistant_boy_det']['last_name'] }}</p>
                                <p style="margin: 0; font-size: 16px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">Email: {{ $data['assistant_boy_det']['email'] }}</p>
                                <p style="margin: 0; font-size: 16px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">Phone: {{ $data['assistant_boy_det']['phone'] }}</p>
                            </div>
                        </div>
