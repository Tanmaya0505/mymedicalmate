                        ...
                        <div
                            ...
                            <div class="txtTinyMce-wrapper"
                                ...
                                <p style="margin: 0; font-size: 16px; line-height: 1.5; word-break: break-word; text-align: center; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">
                                    <span style="font-size: 16px;">The Request has been cancelled by user {{ $assistant_data['customer_det']['patient_name'] }}</span>
                                </p>
                                <p style="margin: 0; font-size: 16px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;"><b>Reason of Cancellation:</b></p>
                                <p style="margin: 0; font-size: 16px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">{{ $assistant_data['cancel_reason'] }}</p>
                            </div>
                        </div>
