                        ...
                        <div
                            ...
                            <div class="txtTinyMce-wrapper"
                                ...
                                <p
                                    ...
                                    <span style="font-size: 16px;">A new user has booked your service Booking ID : {{ $data['booking_id'] }}.<br/> Please confirm customer booking within {{ $data['auto_forward_request'] }} minutes .</span>
                                </p>
