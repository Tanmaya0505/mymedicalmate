    ...
    <div class="row">
            ...
            <div class="panel">
                <div class="user-heading round">
                    ...
                    <div class="user-details">
                        <b><!-- <i class="fal fa-user"></i> -->Clinic Name:</b> {{ ucwords($data->full_name) }}<br>
                        ...
                        <b><!-- <i class="fal fa-map-marker-alt"></i> -->Available Test:</b> {{ $data->available_test }}<br>
        ...
        <div class="col-lg-7 col-xl-8">
            <div class="profile-info">
                <h4 class="mb20">Clinics Details</h4>
