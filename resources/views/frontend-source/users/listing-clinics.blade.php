        ...
        <div class="row clearfix">
            <div class="col-12">
                <div class="text-center wow fadeInDown">
                    <h2 class="center mb30">Clinic Listings</h2>
                </div>
                    ...
                    <div class="card-body" id="filter-content">
                        <form method="GET" action="">
                            ...
                            <div class="form-group">
                                <label for="id1">Clinic Name</label>
                        ...
                        <table>
                            <tr class="hl-header">
                                <td style="width:40%;" class="text-left">
                                    <span class="verified">Clinic <i class="fas fa-check-circle"></i></span>
                                </td>
                                ...
                                <tr class="ast-bx-flex">
                                    ...
                                    <div class="item-image">
                                        <a href="{{ url('/clinics/detail/'.urlencode($val->full_name)) }}">
                                    ...
                                    <div class="item-detail">
                                            <ul>
                                                <li>Clinic Name: <Strong>{{ ucwords($val->full_name) }}</Strong></li>
                                                <li>Location: <Strong>{{ $val->location }}</Strong></li>
                                                
                                                <li>Specialized in: <Strong>{{ $val->specialized }}</Strong></li>
                                ...
                                <td class="text-right">
                                    <a href="{{ url('/clinics/detail/'.urlencode($val->full_name)) }}" class="primary-btn">View Details</a>
                                </td>
                            </tr>
                        </table>
                    </div>
