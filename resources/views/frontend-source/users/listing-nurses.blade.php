        ...
        <div class="row clearfix">
            <div class="col-12">
                <div class="text-center wow fadeInDown">
                    <h2 class="center mb30">Nurse Listings</h2>
                </div>
                        ...
                        <table>
                            <tr class="hl-header">
                                <td style="width:40%;" class="text-left">
                                    <span class="verified">Nurse <i class="fas fa-check-circle"></i></span>
                                </td>
                                ...
                                <tr class="ast-bx-flex">
                                    ...
                                    <div class="item-image">
                                        <a href="{{ url('/nurses/detail/'.urlencode($val->full_name)) }}">
                                ...
                                <td class="text-right">
                                    <a href="{{ url('/nurses/detail/'.urlencode($val->full_name)) }}" class="primary-btn">View Details</a>
                                </td>
                            </tr>
                        </table>
                    </div>
