...
class Helper
{
    ...
    public static function configuration()
    {
        ...
        $response['user_config'] = json_decode($config->user_config);
        $response['assistant_config'] = json_decode($config->assistant_config);
        $response['doctor_config'] = json_decode($config->doctor_config);
        $response['admin_config'] = json_decode($config->admin_config);
        $response['vendor_config'] = json_decode($config->vendor_config);
        $response['deliveryboy_config'] = json_decode($config->deliveryboy_config);
        return $response;
    }
}
