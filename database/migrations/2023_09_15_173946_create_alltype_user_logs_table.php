...
class CreateAlltypeUserLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('alltype_user_logs', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('univercity',70)->nullable();
            $table->string('university_date',70)->nullable();
    ...
    {
        Schema::dropIfExists('alltype_user_logs');
    }
}
